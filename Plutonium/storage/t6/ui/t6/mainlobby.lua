...
CoD.MainLobby.OpenPlayerMatchPartyLobby = function (MainLobbyWidget, ClientInstance)
	...
	elseif CoD.MainLobby.OnlinePlayAvailable(MainLobbyWidget, ClientInstance) == 1 then
		...
		if CoD.isPC == true then
			local ErrorPopup = MainLobbyWidget:openPopup("Error", ClientInstance.controller)
			ErrorPopup:setMessage(Engine.Localize("Local Play is unavailable at this time. Please try again later."))
			ErrorPopup.anyControllerAllowed = true
			return 
		end
...
CoD.MainLobby.OpenLocal = function (MainLobbyWidget, ClientInstance)
	if CoD.MainLobby.ShouldPreventCreateLobby() then
		return 
	elseif CoD.MainLobby.OnlinePlayAvailable(MainLobbyWidget, ClientInstance) == 1 and CoD.MainLobby.IsControllerCountValid(MainLobbyWidget, ClientInstance.controller, UIExpression.DvarInt(ClientInstance.controller, "party_maxlocalplayers_privatematch")) == 1 then
		CoD.SwitchToPrivateLobby(ClientInstance.controller)
...
CoD.MainLobby.OpenMainMenu = function (MainLobbyWidget, ClientInstance)
	if CoD.MainLobby.ShouldPreventCreateLobby() then
		if CoD.isZombie == true then
			MainLobbyWidget:openMenu("button_prompt_back", ClientInstance.controller)
		end
		MainLobbyWidget:close()
	end
end
...
CoD.MainLobby.OpenStore = function (MainLobbyWidget, ClientInstance)
	...
	if CoD.MainLobby.OnlinePlayAvailable(MainLobbyWidget, ClientInstance, true) == 1 then
		if not CoD.isPS3 or UIExpression.IsSubUser(ClientInstance.controller) ~= 1 then
			...
			if CoD.isPC then
				local ErrorPopup = MainLobbyWidget:openPopup("Error", ClientInstance.controller)
				ErrorPopup:setMessage(Engine.Localize("The Store is currently unavailable, Please try again later."))
				ErrorPopup.anyControllerAllowed = true
			end
		end
	end
...
CoD.MainLobby.UpdateButtonPaneButtonVisibilty_Zombie = function (MainLobbyButtonPane)
	if CoD.isPartyHost() then
		...
		MainLobbyButtonPane.body.buttonList:addElement(MainLobbyButtonPane.body.localButton)
		MainLobbyButtonPane.body.buttonList:addElement(MainLobbyButtonPane.body.mainMenuButton)
		...
		MainLobbyButtonPane.body.soloPlayButton:closeAndRefocus(MainLobbyButtonPane.body.soloPlayButton)
		MainLobbyButtonPane.body.customGamesButton:closeAndRefocus(MainLobbyButtonPane.body.customGamesButton)
		MainLobbyButtonPane.body.theaterSpacer:closeAndRefocus(MainLobbyButtonPane.body.theaterSpacer)
		MainLobbyButtonPane.body.theaterButton:closeAndRefocus(MainLobbyButtonPane.body.theaterButton)
		MainLobbyButtonPane.body.optionSpacer:closeAndRefocus(MainLobbyButtonPane.body.optionSpacer)
		MainLobbyButtonPane.body.localButton:closeAndRefocus(MainLobbyButtonPane.body.localButton)
		MainLobbyButtonPane.body.mainMenuButton:closeAndRefocus(MainLobbyButtonPane.body.mainMenuButton)
	end
end
...
--	MainLobbyButtonPane.body.serverBrowserButton.hintText = Engine.Localize("Join a server and Team up with fellow survivors to fight against unending waves of the undead horde.")
...
--	CoD.SetupMatchmakingLock(MainLobbyButtonPane.body.serverBrowserButton)
	MainLobbyButtonPane.body.soloPlayButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_SOLO_CAPS"), nil, 2)
--	MainLobbyButtonPane.body.soloPlayButton.hintText = Engine.Localize("Stand alone against the Undead horde and prove you are the best Zombie slayer.")
...
--	MainLobbyButtonPane.body.customGamesButton.hintText = Engine.Localize("ZMUI_CUSTOM_MATCH_DESC")
...
--	CoD.SetupCustomGamesLock(MainLobbyButtonPane.body.customGamesButton)
	MainLobbyButtonPane.body.theaterSpacer = MainLobbyButtonPane.body.buttonList:addSpacer(CoD.CoD9Button.Height / 2, 3)
...
--	MainLobbyButtonPane.body.theaterButton.hintText = Engine.Localize("ZMUI_THEATER_DESC")
	MainLobbyButtonPane.body.theaterButton:setActionEventName("open_theater_lobby")
	MainLobbyButtonPane.body.codtvButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_COD_TV_CAPS"), nil, 5)
--	MainLobbyButtonPane.body.codtvButton.hintText = Engine.Localize("MPUI_COD_TV_DESC")
	MainLobbyButtonPane.body.codtvButton:setActionEventName("open_cod_tv")
	MainLobbyButtonPane.body.barracksButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_LEADERBOARDS_CAPS"), nil, 6)
--	MainLobbyButtonPane.body.barracksButton.hintText = Engine.Localize("ZMUI_LEADERBOARDS_DESC")
...
--	CoD.SetupBarracksLock(MainLobbyButtonPane.body.barracksButton)
	...
	MainLobbyButtonPane.body.optionsButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_OPTIONS_CAPS"), nil, 7)
--	MainLobbyButtonPane.body.optionsButton.hintText = Engine.Localize("MPUI_OPTIONS_DESC")
	...
	MainLobbyButtonPane.body.localButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_LOCAL_CAPS"), nil, 8)
--	MainLobbyButtonPane.body.localButton.hintText = Engine.Localize("Fight the undead alone or with friends on a Local Network.")
	MainLobbyButtonPane.body.localButton:setActionEventName("open_local")
	MainLobbyButtonPane.body.mainMenuButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_MAIN_MENU_CAPS"), nil, 9)
--	MainLobbyButtonPane.body.mainMenuButton.hintText = Engine.Localize("Close Zombies and open the Main Menu.")
	MainLobbyButtonPane.body.mainMenuButton:setActionEventName("open_main_menu")
	MainLobbyButtonPane.body.storeButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_STORE_CAPS"), nil, 10)
--	MainLobbyButtonPane.body.storeButton.hintText = Engine.Localize("MENU_STORE_DESC")
	MainLobbyButtonPane.body.storeButton:setActionEventName("open_store")
end
...
LUI.createMenu.MainLobby = function (LocalClientIndex)
	local MainLobbyName = Engine.Localize(CoD.MPZM("TEMP", "MENU_ONLINE_CAPS"))
	...
	MainLobbyWidget:registerEventHandler("open_local", CoD.MainLobby.OpenLocal)
	MainLobbyWidget:registerEventHandler("open_main_menu", CoD.MainLobby.OpenMainMenu)

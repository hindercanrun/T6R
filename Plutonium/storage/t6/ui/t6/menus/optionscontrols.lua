...
CoD.OptionsControls.CreateCombatTab = function (combatTab, localClientIndex)
	...
	CoD.OptionsControls.AddKeyBindingElements(localClientIndex, combatTabButtonList, {
		...
		{
			command = "+smoke",
			label = "ATTACHTMENTS/SPECIAL AMMO"
		},
		{
			command = "+smoke",
...
CoD.OptionsControls.CreateInteractTab = function (interactTab, localClientIndex)
	...
	if CoD.isZombie then
		interactTabContents = {
			...
			{
				command = "+scores",
				label = "SHOW OBJECTIVES/SCORE"
			},
			{
				command = "+actionslot 1",
				label = "ACCEPT GAME INVITE"
			}
		}
	end
...
CoD.OptionsControls.CreateZombiesTab = function (ZombiesTab, localClientIndex)
	...
	local ZombiesTabContents = {}
	table.insert(ZombiesTabContents, {
		command = "+talk",
	...
	CoD.OptionsControls.AddKeyBindingElements(localClientIndex, ZombiesTabButtonList, ZombiesTabContents)
...
CoD.OptionsControls.CreateGamepadTab = function (gamepadTab, localClientIndex)
	...
	gamepadButtonList:addSpacer(CoD.CoD9Button.Height / 2)

	CoD.Options.Button_AddChoices_EnabledOrDisabled(gamepadButtonList:addProfileLeftRightSelector(localClientIndex, Engine.Localize("MENU_LOOK_INVERSION_CAPS"), "input_invertpitch"))

	local gamepadThumbSticksOptions = gamepadButtonList:addProfileLeftRightSelector(localClientIndex, Engine.Localize("MENU_THUMBSTICK_LAYOUT_CAPS"), "gpad_sticksConfig")
	...
	local gamepadButtonsOptions = gamepadButtonList:addProfileLeftRightSelector(localClientIndex, Engine.Localize("MENU_BUTTON_LAYOUT_CAPS"), "gpad_buttonsConfig")
	...
	CoD.OptionsControls.Button_AddChoices_LookSensitivity(gamepadButtonList:addProfileLeftRightSelector(localClientIndex, Engine.Localize("MENU_LOOK_SENSITIVITY_CAPS"), "input_viewSensitivity"))
...
LUI.createMenu.OptionsControlsMenu = function (localClientIndex)
	...
	controlsTabs:addTab(localClientIndex, "MENU_ZOMBIES_CAPS", CoD.OptionsControls.CreateZombiesTab)

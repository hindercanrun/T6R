...
LUI.createMenu.SetDefaultPopup = function ( f7_arg0 )
	...
	CoD.PopupMenus.SetupConfirmPopup( f7_local0, "PLATFORM_DEFAULT_SYSTEM_SETTINGS_CAPS", "This will restore all system settings to default, are you sure?", CoD.PopupMenus.GoBack, CoD.PopupMenus.GoBack )
...
LUI.createMenu.SetDefaultControlsPopup = function ( f8_arg0 )
	...
	CoD.PopupMenus.SetupConfirmPopup( f8_local0, "MENU_SET_DEFAULT_CONTROLS_CAPS", "Controls will restored to the games defaults.", CoD.PopupMenus.GoBack, CoD.PopupMenus.GoBack )
...
LUI.createMenu.SwitchToSPPopup = function ( f15_arg0 )
	...
	CoD.PopupMenus.SetupConfirmPopup( f15_local0, "", "Are you sure you want to go to the Main Menu?", CoD.PopupMenus.SwitchToSP, CoD.PopupMenus.GoBack )
...
LUI.createMenu.SwitchToMPPopup = function ( f17_arg0 )
	...
	CoD.PopupMenus.SetupConfirmPopup( f17_local0, "", "Are you sure you want to go Back?", CoD.PopupMenus.SwitchToMP, CoD.PopupMenus.GoBack )

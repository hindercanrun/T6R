...
local GameOptionsDvars = {
	enableCheats = {
		name = "Cheats",
		setting = "sv_cheats",
		hintText = "Enable cheats on the server.",
		labels = CoD.GameOptions.AllowedDisallowedLabels,
		values = CoD.GameOptions.AllowedDisallowedValues,
		shouldShow = AlwaysShow
	}
...
--todo	EditGameOptionsPopup:registerEventHandler("open_custom_classes", OpenCustomClasses)
--todo	EditGameOptionsPopup:registerEventHandler("open_default_classes", OpenPresetClasses)
...
--todo	EditGameOptionsPopup.buttonList:addSpacer(CoD.CoD9Button.Height / 2)
--todo	if Engine.GetGametypeSetting("disableClassSelection", true) == 0 then
--todo		local CustomizeClassesButton = EditGameOptionsPopup.buttonList:addButton(Engine.Localize("MENU_CUSTOM_CLASSES_CAPS"))
--todo		CustomizeClassesButton:setActionEventName("open_custom_classes")
--todo		CustomizeClassesButton:registerEventHandler("button_update", UpdateCustomClassesStarIcon)
--todo		CustomizeClassesButton.gametypeSettings = CoD.GameOptions.CustomClassSettings
--todo		UpdateCustomClassesStarIcon(CustomizeClassesButton)
--todo		local CustomizePresetClassesButton = EditGameOptionsPopup.buttonList:addButton(Engine.Localize("MENU_PRESET_CLASSES_CAPS"))
--todo		CustomizePresetClassesButton:setActionEventName("open_default_classes")
--todo		CustomizePresetClassesButton:registerEventHandler("button_update", UpdatePresetClassesStarIcon)
--todo		CustomizePresetClassesButton.gametypeSettings = CoD.GameOptions.PresetClassSettings
--todo		UpdatePresetClassesStarIcon(CustomizePresetClassesButton)
--todo	end
...
--todo OpenCustomClasses = function (EditGameOptionsPopup, ClientInstance)
--todo	 EditGameOptionsPopup.buttonList:saveState()
--todo	 EditGameOptionsPopup:openMenu("CustomClassGameOptions", ClientInstance.controller)
--todo	 EditGameOptionsPopup:close()
--todo end
--todo
--todo OpenPresetClasses = function (EditGameOptionsPopup, ClientInstance)
--todo	 EditGameOptionsPopup.buttonList:saveState()
--todo	 EditGameOptionsPopup:openMenu("EditDefaultClasses", ClientInstance.controller)
--todo	 EditGameOptionsPopup:close()
--todo end
...
--todo CheckTeamPresetClasses = function (TeamEnum)
--todo	 for Index = 0, 4, 1 do
--todo		 if not Engine.IsPresetClassDefault(TeamEnum, Index) then
--todo			 return false
--todo		 end
--todo	 end
--todo	 return true

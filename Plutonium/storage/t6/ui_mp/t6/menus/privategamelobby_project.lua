...
CoD.PrivateGameLobby.GameTypeSettings[1].values[3] = 2
CoD.PrivateGameLobby.GameTypeSettings[1].gameTypes = {}
--todo CoD.PrivateGameLobby.GameTypeSettings[1].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.GameTypeSettings[1].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.GameTypeSettings[1].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.GameTypeSettings[1].gameTypes[4] = "zcleansed"
...
CoD.PrivateGameLobby.GameTypeSettings[2].labels[8] = "35"
CoD.PrivateGameLobby.GameTypeSettings[2].labels[9] = "40"
CoD.PrivateGameLobby.GameTypeSettings[2].labels[10] = "45"
CoD.PrivateGameLobby.GameTypeSettings[2].labels[11] = "50"
...
CoD.PrivateGameLobby.GameTypeSettings[2].values[8] = 35
CoD.PrivateGameLobby.GameTypeSettings[2].values[9] = 40
CoD.PrivateGameLobby.GameTypeSettings[2].values[10] = 45
CoD.PrivateGameLobby.GameTypeSettings[2].values[11] = 50
CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes = {}
--todo CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.GameTypeSettings[2].gameTypes[4] = "zcleansed"
...
--todo CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.GameTypeSettings[3].gameTypes[4] = "zcleansed"
...
--todo CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes[4] = "zcleansed"
...
--todo CoD.PrivateGameLobby.GameTypeSettings[5].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.GameTypeSettings[5].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.GameTypeSettings[5].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.GameTypeSettings[5].gameTypes[4] = "zcleansed"
...
--todo CoD.PrivateGameLobby.GameTypeSettings[6].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.GameTypeSettings[6].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.GameTypeSettings[6].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.GameTypeSettings[6].gameTypes[4] = "zcleansed"
CoD.PrivateGameLobby.DvarDefaults = {}
CoD.PrivateGameLobby.DvarDefaults["sv_cheats"] = 0
--todo CoD.PrivateGameLobby.DvarDefaults["zombies_minplayers"] = 1
--todo CoD.PrivateGameLobby.Dvars = {}
--todo CoD.PrivateGameLobby.Dvars[1] = {}
--todo CoD.PrivateGameLobby.Dvars[1].id = "zombies_minplayers"
--todo CoD.PrivateGameLobby.Dvars[1].name = "MIN PLAYERS"
--todo CoD.PrivateGameLobby.Dvars[1].hintText = "The game will wait at the loadscreen until the amount of players ingame is reached."
--todo CoD.PrivateGameLobby.Dvars[1].labels = {}
--todo CoD.PrivateGameLobby.Dvars[1].labels[1] = "1"
--todo CoD.PrivateGameLobby.Dvars[1].labels[2] = "2"
--todo CoD.PrivateGameLobby.Dvars[1].labels[3] = "3"
--todo CoD.PrivateGameLobby.Dvars[1].labels[4] = "4"
--todo CoD.PrivateGameLobby.Dvars[1].labels[5] = "5"
--todo CoD.PrivateGameLobby.Dvars[1].labels[6] = "6"
--todo CoD.PrivateGameLobby.Dvars[1].labels[7] = "7"
--todo CoD.PrivateGameLobby.Dvars[1].labels[8] = "8"
--todo CoD.PrivateGameLobby.Dvars[1].values = {}
--todo CoD.PrivateGameLobby.Dvars[1].values[1] = 1
--todo CoD.PrivateGameLobby.Dvars[1].values[2] = 2
--todo CoD.PrivateGameLobby.Dvars[1].values[3] = 3
--todo CoD.PrivateGameLobby.Dvars[1].values[4] = 4
--todo CoD.PrivateGameLobby.Dvars[1].values[5] = 5
--todo CoD.PrivateGameLobby.Dvars[1].values[6] = 6
--todo CoD.PrivateGameLobby.Dvars[1].values[7] = 7
--todo CoD.PrivateGameLobby.Dvars[1].values[8] = 8
--todo CoD.PrivateGameLobby.Dvars[1].gameTypes = {}
--todo CoD.PrivateGameLobby.Dvars[1].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.Dvars[1].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.Dvars[1].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.Dvars[1].gameTypes[4] = "zcleansed"
...
--todo CoD.PrivateGameLobby.Dvars[2].gameTypes[1] = "zclassic"
--todo CoD.PrivateGameLobby.Dvars[2].gameTypes[2] = "zstandard"
--todo CoD.PrivateGameLobby.Dvars[2].gameTypes[3] = "zgrief"
--todo CoD.PrivateGameLobby.Dvars[2].gameTypes[4] = "zcleansed"
...
--todo	if not CoD.isZombie then
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeMapButton = PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.buttonList:addButton(Engine.Localize("MPUI_CHANGE_MAP_CAPS"))
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeMapButton.hintText = Engine.Localize("MPUI_CHANGE_MAP_DESC")
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeMapButton:setActionEventName("open_change_map")
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeMapButton:registerEventHandler("button_update", CoD.PrivateGameLobby.Button_UpdateHostButton)
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeGameModeButton = PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.buttonList:addButton(Engine.Localize("MPUI_CHANGE_GAME_MODE_CAPS"))
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeGameModeButton.hintText = Engine.Localize("MPUI_CHANGE_GAME_MODE_DESC")
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeGameModeButton:setActionEventName("open_change_game_mode")
--todo		PrivateGameLobbyButtonPane.body.setupGameFlyoutContainer.changeGameModeButton:registerEventHandler("button_update", CoD.PrivateGameLobby.Button_UpdateHostButton)
--todo	end
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		PrivateGameLobbyButtonPane.body.changeGamemodeButton:setActionEventName("")
		...
		local f9_local1_1, f9_local1_2, f9_local1_3, f9_local1_4 = GetTextDimensions(SetupGameText, CoD.CoD9Button.Font, CoD.CoD9Button.TextHeight)
		PrivateGameLobbyButtonPane.body.setupGameButton = PrivateGameLobbyButtonPane.body.buttonList:addButton(SetupGameText)
		PrivateGameLobbyButtonPane.body.setupGameButton.hintText = Engine.Localize("MPUI_EDIT_GAME_RULES_DESC")
		PrivateGameLobbyButtonPane.body.setupGameButton:setActionEventName("open_editGameOptions_menu")
		PrivateGameLobbyButtonPane.body.setupGameButton:registerEventHandler("button_update", CoD.PrivateGameLobby.Button_UpdateHostButton)
		if PrivateGameLobbyButtonPane.body.widestButtonTextWidth < f9_local1_3 then
		 PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		end

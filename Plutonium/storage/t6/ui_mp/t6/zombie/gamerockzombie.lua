...
CoD.GameRockZombie.RockTileWidth = 0
CoD.GameRockZombie.RockTileHeight = 0
...
CoD.GameRockZombie.RockFrontTranslatingSpeed = 0
CoD.GameRockZombie.RockFrontPathNodeCount = 0
CoD.GameRockZombie.RockFrontPathNodeCurrentIndex = 0
CoD.GameRockZombie.RockFrontPath[1] = {
	x = -CoD.GameRockZombie.RockTileWidth * 0,
	y = CoD.GameRockZombie.RockTileHeight * 0
}
...
CoD.GameRockZombie.RockFrontBTranslatingSpeed = 0
CoD.GameRockZombie.RockFrontBPathNodeCount = 0
CoD.GameRockZombie.RockFrontBPathNodeCurrentIndex = 0
...
CoD.GameRockZombie.RockBackTranslatingSpeed = 0
CoD.GameRockZombie.RockBackPathNodeCount = 0
CoD.GameRockZombie.RockBackPathNodeCurrentIndex = 0
...
CoD.GameRockZombie.Init = function ( f1_arg0, f1_arg1 )
	...
	self:setLeftRight( false, false, CoD.GameRockZombie.RockFrontPath[1].x - CoD.GameRockZombie.RockTileWidth * 0, CoD.GameRockZombie.RockFrontPath[1].x + CoD.GameRockZombie.RockTileWidth * 0 )
	self:setTopBottom( false, false, CoD.GameRockZombie.RockFrontPath[1].y - CoD.GameRockZombie.RockTileHeight * 0, CoD.GameRockZombie.RockFrontPath[1].y + CoD.GameRockZombie.RockTileHeight * 0 )
	...
	f1_local1:setLeftRight( false, false, CoD.GameRockZombie.RockFrontPath[1].x - CoD.GameRockZombie.RockTileWidth * 0, CoD.GameRockZombie.RockFrontPath[1].x + CoD.GameRockZombie.RockTileWidth * 0 )
	f1_local1:setTopBottom( false, false, CoD.GameRockZombie.RockFrontPath[1].y - CoD.GameRockZombie.RockTileHeight * 0, CoD.GameRockZombie.RockFrontPath[1].y + CoD.GameRockZombie.RockTileHeight * 0 )
	...
	f1_local2:setLeftRight( false, false, CoD.GameRockZombie.RockFrontBPath[1].x - CoD.GameRockZombie.RockTileWidth * 0, CoD.GameRockZombie.RockFrontBPath[1].x + CoD.GameRockZombie.RockTileWidth * 0 )
	f1_local2:setTopBottom( false, false, CoD.GameRockZombie.RockFrontBPath[1].y - CoD.GameRockZombie.RockTileHeight * 0, CoD.GameRockZombie.RockFrontBPath[1].y + CoD.GameRockZombie.RockTileHeight * 0 )
	...
	f1_local3:setLeftRight( false, false, CoD.GameRockZombie.RockFrontBPath[1].x - CoD.GameRockZombie.RockTileWidth * 0, CoD.GameRockZombie.RockFrontBPath[1].x + CoD.GameRockZombie.RockTileWidth * 0 )
	f1_local3:setTopBottom( false, false, CoD.GameRockZombie.RockFrontBPath[1].y - CoD.GameRockZombie.RockTileHeight * 0, CoD.GameRockZombie.RockFrontBPath[1].y + CoD.GameRockZombie.RockTileHeight * 0 )
	...
	f1_local4:setLeftRight( false, false, CoD.GameRockZombie.RockBackPath[1].x - CoD.GameRockZombie.RockTileWidth * 0, CoD.GameRockZombie.RockBackPath[1].x + CoD.GameRockZombie.RockTileWidth * 0 )
	f1_local4:setTopBottom( false, false, CoD.GameRockZombie.RockBackPath[1].y - CoD.GameRockZombie.RockTileHeight * 0, CoD.GameRockZombie.RockBackPath[1].y + CoD.GameRockZombie.RockTileHeight * 0 )
	...
	f1_local5:setLeftRight( false, false, CoD.GameRockZombie.RockBackPath[1].x - CoD.GameRockZombie.RockTileWidth * 0, CoD.GameRockZombie.RockBackPath[1].x + CoD.GameRockZombie.RockTileWidth * 0 )
	f1_local5:setTopBottom( false, false, CoD.GameRockZombie.RockBackPath[1].y - CoD.GameRockZombie.RockTileHeight * 0, CoD.GameRockZombie.RockBackPath[1].y + CoD.GameRockZombie.RockTileHeight * 0 )
...
CoD.GameRockZombie.InitPath = function ()
	...
	local f2_local2 = 0
	local f2_local3 = 0
	for f2_local4 = 2, CoD.GameRockZombie.RockFrontPathNodeCount, 0 do
		f2_local3 = f2_local4 - 0
...
CoD.GameRockZombie.RegisterMoveToNextState = function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3, f3_arg4 )
	...
	f3_arg0:setLeftRight( false, false, f3_local0.x - CoD.GameRockZombie.RockTileWidth * 0, f3_local0.x + CoD.GameRockZombie.RockTileWidth * 0 )
	f3_arg0:setTopBottom( false, false, f3_local0.y - CoD.GameRockZombie.RockTileHeight * 0, f3_local0.y + CoD.GameRockZombie.RockTileHeight * 0 )
end

CoD.GameRockZombie.RockFront1MoveToNextFinish = function ( f4_arg0, f4_arg1 )
	if f4_arg1.interrupted == nil then
		if CoD.GameRockZombie.RockFrontPathNodeCurrentIndex == 0 then
			CoD.GameRockZombie.RegisterMoveToNextState( f4_arg0, true, 0, true )
			if not CoD.GameRockZombie.ShouldStop then
				CoD.GameRockZombie.RockFrontPathNodeCurrentIndex = 0
				CoD.GameRockZombie.RegisterMoveToNextState( f4_arg0, false, 0, true )
			else
				CoD.GameRockZombie.RockFrontPathNodeCurrentIndex = 0
			end
			CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksFront.rock2, false, 0, true )
		elseif CoD.GameRockZombie.RockFrontPathNodeCurrentIndex == 0 then
			CoD.GameRockZombie.RegisterMoveToNextState( f4_arg0, false, 0, true )
			CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksFront.rock2, true, 0, true )
			if not CoD.GameRockZombie.ShouldStop then
				CoD.GameRockZombie.RockFrontPathNodeCurrentIndex = 0
				CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksFront.rock2, false, 0, true )
			else
...
CoD.GameRockZombie.RockFront3MoveToNextFinish = function ( f5_arg0, f5_arg1 )
	if f5_arg1.interrupted == nil then
		if CoD.GameRockZombie.RockFrontBPathNodeCurrentIndex == 0 then
			CoD.GameRockZombie.RegisterMoveToNextState( f5_arg0, true, 0, true, true )
			if not CoD.GameRockZombie.ShouldStop then
				CoD.GameRockZombie.RockFrontBPathNodeCurrentIndex = 0
				CoD.GameRockZombie.RegisterMoveToNextState( f5_arg0, false, 0, true, true )
			else
				CoD.GameRockZombie.RockFrontBPathNodeCurrentIndex = 0
			end
			CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksFront.rock4, false, 0, true, true )
		elseif CoD.GameRockZombie.RockFrontBPathNodeCurrentIndex == 0 then
			CoD.GameRockZombie.RegisterMoveToNextState( f5_arg0, false, 0, true, true )
			CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksFront.rock4, true, 0, true, true )
			if not CoD.GameRockZombie.ShouldStop then
				CoD.GameRockZombie.RockFrontBPathNodeCurrentIndex = 0
				CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksFront.rock4, false, 0, true, true )
			else
...
CoD.GameRockZombie.RockBack1MoveToNextFinish = function ( f6_arg0, f6_arg1 )
	if f6_arg1.interrupted == nil then
		if CoD.GameRockZombie.RockBackPathNodeCurrentIndex == 0 then
			CoD.GameRockZombie.RegisterMoveToNextState( f6_arg0, true, 0, false )
			if not CoD.GameRockZombie.ShouldStop then
				CoD.GameRockZombie.RockBackPathNodeCurrentIndex = 0
				CoD.GameRockZombie.RegisterMoveToNextState( f6_arg0, false, 0, false )
			else
				CoD.GameRockZombie.RockBackPathNodeCurrentIndex = 0
			end
			CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksBack.rock2, false, 0, false )
		elseif CoD.GameRockZombie.RockBackPathNodeCurrentIndex == 0 then
			CoD.GameRockZombie.RegisterMoveToNextState( f6_arg0, false, 0, false )
			CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksBack.rock2, true, 0, false )
			if not CoD.GameRockZombie.ShouldStop then
				CoD.GameRockZombie.RockBackPathNodeCurrentIndex = 0
				CoD.GameRockZombie.RegisterMoveToNextState( CoD.GameRockZombie.gameRocksBack.rock2, false, 0, false )
			else
...
CoD.GameRockZombie.Reset = function ( f9_arg0, f9_arg1 )
	f9_arg0:setLeftRight( false, false, f9_arg1.x - CoD.GameRockZombie.RockTileWidth * 0, f9_arg1.x + CoD.GameRockZombie.RockTileWidth * 0 )
	f9_arg0:setTopBottom( false, false, f9_arg1.y - CoD.GameRockZombie.RockTileHeight * 0, f9_arg1.y + CoD.GameRockZombie.RockTileHeight * 0 )
end

CoD.GameRockZombie.HideAll = function ()
	CoD.GameRockZombie.gameRocksFront:beginAnimation( "hide", 0 )
	CoD.GameRockZombie.gameRocksFront:setAlpha( 0 )
	CoD.GameRockZombie.gameRocksBack:beginAnimation( "hide", 0 )
	CoD.GameRockZombie.gameRocksBack:setAlpha( 0 )
end

CoD.GameRockZombie.ShowAll = function ()
	CoD.GameRockZombie.gameRocksFront:beginAnimation( "show", 0 )
	CoD.GameRockZombie.gameRocksFront:setAlpha( 0 )
	CoD.GameRockZombie.gameRocksBack:beginAnimation( "show", 0 )
	CoD.GameRockZombie.gameRocksBack:setAlpha( 0 )
end
...
CoD.Fog.Init = function ( f12_arg0 )
	...
	self:setLeftRight( false, false, CoD.Fog.Path[2].x - CoD.Fog.TileWidth * 0, CoD.Fog.Path[2].x + CoD.Fog.TileWidth * 0 )
	...
	f12_local1:setLeftRight( false, false, CoD.Fog.Path[1].x - CoD.Fog.TileWidth * 0, CoD.Fog.Path[1].x + CoD.Fog.TileWidth * 0 )
...
CoD.Fog.RegisterMoveToNextState = function ( f20_arg0, f20_arg1, f20_arg2 )
	...
	f20_arg0:setLeftRight( false, false, f20_local0.x - CoD.Fog.TileWidth * 0, f20_local0.x + CoD.Fog.TileWidth * 0 )
end

CoD.Fog.Reset = function ( f21_arg0, f21_arg1 )
	f21_arg0:completeAnimation()
	f21_arg0:setLeftRight( false, false, f21_arg1.x - CoD.Fog.TileWidth * 0, f21_arg1.x + CoD.Fog.TileWidth * 0 )
end

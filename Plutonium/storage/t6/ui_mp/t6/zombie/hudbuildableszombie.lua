...
LUI.createMenu.BuildablesArea = function ( f1_arg0 )
	local f1_local0 = CoD.Menu.NewSafeAreaFromState( "BuildablesArea", f1_arg0 )
	...
	if CoD.Zombie.IsDLCMap( CoD.Zombie.DLC3Maps ) == false then
		...
		local f1_local1 = CoD.PowerUps.IconSize * 2.8
		local f1_local2 = f1_local1 + CoD.Buildables.IconSize
		local f1_local3 = 0
		local f1_local4 = f1_local3 - CoD.Buildables.IconSize
		local self = LUI.UIImage.new()
		self:setLeftRight( false, false, f1_local1, f1_local2 )
		self:setTopBottom( false, true, f1_local4, f1_local3 )
		self:setAlpha( 0 )
		self:registerEventHandler( "transition_complete_off_fade_out", CoD.Buildables.PowerUpIcon_UpdatePosition )
		f1_local0.scaleContainer:addElement( self )
		f1_local0.pieceIcons = {}
		f1_local0.pieceIcons[0] = self
		f1_local0:registerEventHandler( CoD.Buildables.ClientFieldBuildableName, CoD.Buildables.Update )
	else
		f1_local0.scaleContainer = CoD.SplitscreenScaler.new( nil, CoD.Zombie.SplitscreenMultiplier )
		...
		f1_local0:addElement( f1_local0.scaleContainer )
		local f1_local1 = 230
		local f1_local3 = 0 - CoD.Buildables.IconSize
		local f1_local4 = LUI.UIImage.new()
		f1_local4:setLeftRight( false, true, -CoD.Buildables.IconSize - f1_local1, -f1_local1 )
		f1_local4:setTopBottom( false, true, -CoD.Buildables.IconSize, 0 )
		f1_local4:setAlpha( 0 )
		f1_local4:registerEventHandler( "transition_complete_off_fade_out", CoD.Buildables.PowerUpIcon_UpdatePosition )
		f1_local0.scaleContainer:addElement( f1_local4 )
		f1_local0.pieceIcons = {}
		f1_local0.pieceIcons[0] = f1_local4
		f1_local0:registerEventHandler( CoD.Buildables.ClientFieldBuildableName, CoD.Buildables.Update )
		local self = f1_local1 + CoD.Buildables.IconSize + 2
		local f1_local6 = LUI.UIImage.new()
		f1_local6:setLeftRight( false, true, -CoD.Buildables.IconSize - self, -self )
		f1_local6:setTopBottom( false, true, -CoD.Buildables.IconSize, 0 )
		f1_local6:setAlpha( 0 )
		f1_local6:registerEventHandler( "transition_complete_off_fade_out", CoD.Buildables.PowerUpIcon_UpdatePosition )
		f1_local0.scaleContainer:addElement( f1_local6 )
		f1_local0.pieceIcons[1] = f1_local6
		f1_local0:registerEventHandler( CoD.Buildables.ClientFieldBuildableName2, CoD.Buildables.UpdatePU )
		local f1_local7 = self + CoD.Buildables.IconSize + 2
		local f1_local8 = LUI.UIImage.new()
		f1_local8:setLeftRight( false, true, -CoD.Buildables.IconSize - f1_local7, -f1_local7 )
		f1_local8:setTopBottom( false, true, -CoD.Buildables.IconSize, 0 )
		f1_local8:setAlpha( 0 )
		f1_local8:registerEventHandler( "transition_complete_off_fade_out", CoD.Buildables.PowerUpIcon_UpdatePosition )
		f1_local0.scaleContainer:addElement( f1_local8 )
		f1_local0.pieceIcons[2] = f1_local8
		f1_local0:registerEventHandler( CoD.Buildables.ClientFieldBuildableName3, CoD.Buildables.UpdateSQ )
	end
	f1_local0:registerEventHandler( "hud_update_refresh", CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_EMP_ACTIVE, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_HUD_VISIBLE, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_UI_ACTIVE, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_SPECTATING_CLIENT, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_SCOREBOARD_OPEN, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_IN_VEHICLE, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_IN_GUIDED_MISSILE, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_IN_REMOTE_KILLSTREAK_STATIC, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_IS_SCOPED, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_IS_FLASH_BANGED, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_DEMO_CAMERA_MODE_MOVIECAM, CoD.Buildables.UpdateVisibility )
	f1_local0:registerEventHandler( "hud_update_bit_" .. CoD.BIT_DEMO_ALL_GAME_HUD_HIDDEN, CoD.Buildables.UpdateVisibility )
	f1_local0.visible = true
	return f1_local0
end

CoD.Buildables.UpdateVisibility = function ( f2_arg0, f2_arg1 )
...
CoD.Buildables.UpdateForSlot = function ( f3_arg0, f3_arg1, f3_arg2 )
	local f3_local0 = Dvar.ui_mapname:get()
	if f3_local0 ~= nil then
		if f3_arg1.newValue == CoD.Buildables.BUILDABLE_PIECE_NONE then
			f3_arg0.pieceIcons[f3_arg2]:beginAnimation( "fade_out", CoD.Buildables.PIECE_FADEOUT_DURATION )
			f3_arg0.pieceIcons[f3_arg2]:setAlpha( 0 )
		else
			if CoD.Buildables.ClientFieldBuildableStates[f3_local0] ~= nil then
				f3_arg0.pieceIcons[f3_arg2]:setImage( CoD.Buildables.ClientFieldBuildableStates[f3_local0][f3_arg2][f3_arg1.newValue] )
			end
			f3_arg0.pieceIcons[f3_arg2]:setAlpha( 1 )
		end
	end
end

CoD.Buildables.Update = function ( f4_arg0, f4_arg1 )
	CoD.Buildables.UpdateForSlot( f4_arg0, f4_arg1, 0 )
end

CoD.Buildables.UpdatePU = function ( f5_arg0, f5_arg1 )
	CoD.Buildables.UpdateForSlot( f5_arg0, f5_arg1, 1 )
end

CoD.Buildables.UpdateSQ = function ( f6_arg0, f6_arg1 )
	CoD.Buildables.UpdateForSlot( f6_arg0, f6_arg1, 2 )
end
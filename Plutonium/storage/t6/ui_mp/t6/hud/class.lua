...
CoD.Class.PrepareClassButtonList = function (LocalClientIndex, IngameMenuWidget)
	...
	if CoD.isZombie == true then
		if Engine.CanPauseZombiesGame() and CoD.canLeaveGame(LocalClientIndex) then
			CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("RESUME CARNAGE"), "soloResumeGame")
		end
	else
	...
	CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("SETTINGS"), "open_options")
	if CoD.canLeaveGame(LocalClientIndex) then
		if CoD.isHost() then
			CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("RESTART LEVEL"), "open_restartGamePopup")
			CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("QUIT"), "open_endGamePopup")
		else
			CoD.Class.AddButton(IngameMenuWidget, Engine.Localize("QUIT"), "open_endGamePopup")
		end
	end
...
LUI.createMenu.class = function (LocalClientIndex)
	...
	IngameMenuWidget:registerEventHandler("open_restartGamePopup", CoD.Class.RestartGameButtonPressed)
